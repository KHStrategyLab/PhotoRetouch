...
public static class AnchorWarpHandleGroupBuilder
{
    ...
    private static void AddChinGroup(AnchorWarpHandleGroupSet set, AnchorMeshFeature? faceOutline)
    {
        ...
        string[] chinPoints = ["FaceOutline_06", "FaceOutline_07", "FaceOutline_08", "FaceOutline_09", "FaceOutline_10"];
        group.ControlPointNames.AddRange(chinPoints);
        group.FalloffPointNames.AddRange(["FaceOutline_04", "FaceOutline_05", "FaceOutline_11", "FaceOutline_12"]);
        group.LockedPointNames.AddRange(["Nose_08", "LipOuter_18"]);
        AnchorMeshPoint? chin = faceOutline.Points.FirstOrDefault(point => point.Name == "FaceOutline_08");
        if (chin is not null)
        {
    ...
    private static void AddJawlineGroup(AnchorWarpHandleGroupSet set, AnchorMeshFeature? faceOutline)
    {
        ...
        string[] jawPoints = ["FaceOutline_04", "FaceOutline_05", "FaceOutline_06", "FaceOutline_10", "FaceOutline_11", "FaceOutline_12"];
        group.ControlPointNames.AddRange(jawPoints);
        group.FalloffPointNames.AddRange(["FaceOutline_03", "FaceOutline_07", "FaceOutline_09", "FaceOutline_13"]);
        group.LockedPointNames.AddRange(["Nose_08", "LipOuter_18"]);
        AddNamedPointHandle(group, faceOutline, "JawLeft", AnchorWarpHandleKind.Left, ["FaceOutline_04", "FaceOutline_05", "FaceOutline_06"], "FaceOutline_05");
        AddNamedPointHandle(group, faceOutline, "JawRight", AnchorWarpHandleKind.Right, ["FaceOutline_10", "FaceOutline_11", "FaceOutline_12"], "FaceOutline_11");
        set.Groups.Add(group);
    }
