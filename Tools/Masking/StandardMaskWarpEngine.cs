...
public sealed class StandardMaskWarpEngine : IPortraitMaskEngine
{
    ...
    public string MaskVersion => "color_mask_only_v1+color_mask_no_protection_subtract_v1+internal_soft_masks_no_channel_cutout_v1+anchor_template_masks_v16+eye_corner_roles+pupil_circle_roles+eyebrow_analyzer_module_v1+brow_30pt_closed_free_polygon_shape_v1+brow_orbital_arc_roi_wider_lower_to_eye_v1+brow_evidence_only_no_brush_cover_v1+brow_no_anchor_draw_when_absent_v1+brow_eye_anchor_roi_pixel_evidence_v3+brow_skin_average_boundary_free_polygon_v1+brow_presnap_boundary_moves_3d_line_v1+brow_eye_distance_ratio_guard_v1+nose_surface_masks_bridge_tip_wings_base_v1+nostril_anchor_ellipse_no_png_v1+mouth_shared_corner_double_almond_loop_v1+lip_anchor_primary_no_png_dummy_v1+lip_surface_loop_soft_fill_v1+lip_no_edit_not_hardprotect_overlay_v1+lip_phase_two_long_surface_planes_v1+mouth_nose_proximity_guard_v1+chin_jawline_roles+nose_tip_nostril_equilateral+face_outline_chin_nostril_compass_1p0_no_circle_v1+face_outline_no_egg_shrink_v1+face_outline_50pt_test_v1+snap_distance_ratio_face24_brow62_eye42_v1+neck_restored+face_outline_50_eye_nose_band_component_position_snap+anchormesh_final_mask_policy_v1+no_ear_features+no_standard_dummy+nostril_standalone_mask_removed_v1+" + _faceAnalyzer.AnalyzerVersion + "+" + _parsingDetector.DetectorVersion;
