...
- ORDER_20 first pass adds a Debug Mask selector for Final, Skin, HardProtect, SoftProtect, RetouchAllow, Eye, Eyebrow, Lip, InnerMouth, Nostril, Hair, Beard, and Glasses overlays. Selection changes reuse SnapshotMask and do not rerun retouch filters.
...
- ORDER_20 second pass for filter candidate overlays such as Blemish, Wrinkle, ToneEven, TextureRestore, HardProtectDiff, and Stage compare view from cached retouch output.
